...
#human annotation
elk_counts_hsa <- read.csv("Elk_serum_miRNA_raw_counts.csv", row.names = 1)
#(593 miRNAs via human annotation)

#mouse annotation
elk_counts_mmu <- read.csv("Elk_serum_miRNA_raw_counts_mouse_annotation.csv", row.names = 1)
...
#load elk miRNA data
elk_counts <- read.csv("Elk_serum_miRNA_raw_counts.csv", row.names = 1)

#load hamster miRNA data
hamster_counts <- read.csv("Hamster_serum_miRNA_raw_counts.csv", row.names = 1)

#load mouse miRNA data
mouse_counts <- read.csv("HSA_Mouse_raw_miRNA_counts.csv", row.names = 1, check.names = FALSE)

#load human
human_counts <- read.csv("Human_raw_counts_hsa.csv", row.names = 1)
...
#load elk miRNA data
elk_counts <- read.csv("Elk_serum_miRNA_raw_counts.csv", row.names = 1)
elk_samples <- read.csv("Elk_Sample_Data.csv", row.names = 1)
...
clean_samples <- as.character(elk_samples[elk_samples$Hemolysis == "Non_Hemo",]$Sample)
...
#save results
write.csv(DE_miRNA_full, "Elk_DE_miRNA_full.csv")
...
write.csv(DE_miRNA_clean, "Res_elk_cleaned.csv")
...
write.csv(DE_miRNA_clean[best_elk_biomarkers,], "Best_elk_biomarkers_cleaned.csv")
...
#annotation info
ann <- read.csv("Elk_Sample_Data.csv", row.names = 1)
...
#Load hamster data
hamster_counts <- read.csv("Hamster_serum_miRNA_raw_counts.csv", row.names = 1)
hamster_samples <- read.csv("Hamster_samples.csv")
...
write.csv(DE_miRNA_hamster, "Hamster_results.csv")

###Compare results
###compare with full elk DE miRNA
#load data
Elk_full <- read.csv("Elk_DE_miRNA_full.csv", row.names = 1)
...
Elk_biomarkers <- read.csv("Best_elk_biomarkers_cleaned.csv", row.names = 1)
...
elk_biomarkers <- read.csv("Best_elk_biomarkers_cleaned.csv", row.names = 1)
hamster_biomarkers <- read.csv("Hamster_results.csv", row.names = 1)
...
write.csv(AUC_values, "AUC_individual_miRNAs.csv", row.names = FALSE)
